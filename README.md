...
* [**The 2025 Civic Briefing (Standard Edition)**](https://drive.google.com/open?id=1kckkAXkBihORv5TziKjZIYecxo9RyB) `press-pamphlet.pdf` — A concise summary of the Governmentality 2025 project, formatted for rapid onboarding of parliamentary staff and the public.  
* [**The 2025 Civic Briefing (Optimised/Technical Edition)**](https://drive.google.com/open?id=1id8T6rnwBr63fgFpJdawi30eM3rDEok9) `press-pamphlet-3o.pdf` — An expanded version of the pamphlet focusing on the "Architecture of Accountability" and the technical failures of the Executive.  
* [**The Meinhardt Gallery: Rapid Access QR Asset**](https://drive.google.com/open?id=1YJXycFDepixAksfl6z5w-VL04tkqI-GL) `meinhardt-public-relations-qr1.png` — A high-resolution media asset providing a direct digital bridge to the full evidentiary repository.  
